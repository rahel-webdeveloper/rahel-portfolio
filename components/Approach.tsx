  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="dark:text-white text-sm font-bold opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-2 group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 text-center">
          {description}
        </h2>
      </div>
    </div>
...
const AceternityIcon = ({ order }: { order: string }) => {
  return (
    <div>
      <MagicButton
        title={order}
        otherClasses="font-bold text-xl rounded-full"
      />
    </div>
  );
};
